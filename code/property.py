...
class Candidate(object):
    def __init__(self,automata,edge,control_properties):
        self.control_properties = control_properties
...
class State(object):
    ...
    def __init__(self, name,controlproperties):
        self.name = name
...
class Automata(object):
    def __init__(self):
        ...
        self.property = ""
        self.APs = []
        self.weak_coverge_edges = []
        self.strong_coverge_edges = []
    ...
    def add_coverge(self,edge):
        if edge not in self.weak_coverge_edges:
            self.weak_coverge_edges.append(edge)
        if edge not in self.strong_coverge_edges:
            self.strong_coverge_edges.append(edge)
    ...
    def find_next_edges_not_covered(self):
        next_edges = []
        for edge in self.edges:
            if edge.start_state == self.now_state and edge not in self.weak_coverge_edges:
                next_edges.append(edge)
        return next_edges
...
class Edge(object):
    ...
    def __init__(self, start_state, end_state,property):
